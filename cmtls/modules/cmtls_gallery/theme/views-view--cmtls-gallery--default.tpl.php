<div id="text-container" class="cmtls-folders-container">
	...
	<div class="toolbar">
	    <?php if(cmtls_group_can_create_content($cmtls['current_group'], $user)): ?>
	            <?php print l(t('+ Add folder'), 'cmtls/'.$cmtls['current_group']->nid.'/'.$cmtls['current_app']->nid.'/album/add', array('attributes' => array('class' => 'button add modalframe-child', 'id' => 'add-album-button'))) ?>
	            <div class="clear"></div>
	    <?php endif; ?>
	</div> <!-- toolbar -->
